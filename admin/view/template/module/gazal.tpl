...
if(empty($gazal_facebook_link)) $gazal_facebook_link ="https://www.facebook.com/envato";
if(empty($gazal_twitter_link)) $gazal_twitter_link ="https://www.twitter.com/envato";
			...
			<div id="footer2_settings" class="divtab">
            	...
            	<div class="tab_container">
                    ...
                    <div id="timer" class="tab_content">
                    	<table class="form">
                        	<tr>   
                                <td><input type="text" name="gazal_time_text" value="<?php echo $gazal_time_text; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div id="firstblock" class="tab_content">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="gazal_firstblock_title" value="<?php echo $gazal_firstblock_title; ?>" /></td>
                            </tr>
                            
                            <tr>
                                <td><?php echo $entry_gazal_firstblock_desc; ?></td>
                                <td><input type="text" name="gazal_firstblock_desc" value="<?php echo $gazal_firstblock_desc; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                    <!--///////////////////////////////////////////////////////////////////////////////// -->
                    <div id="secondblock" class="tab_content">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="gazal_secondblock_title" value="<?php echo $gazal_secondblock_title; ?>" /></td>
                            </tr>
                            
                            <tr>
                                <td><?php echo $entry_gazal_secondblock_desc; ?></td>
                                <td><input type="text" name="gazal_secondblock_desc" value="<?php echo $gazal_secondblock_desc; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                    <!--///////////////////////////////////////////////////////////////////////////////// -->
                    <div id="thirdblock" class="tab_content">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="gazal_thirdblock_title" value="<?php echo $gazal_thirdblock_title; ?>" /></td>
                            </tr>
                            
                            <tr>
                                <td><?php echo $entry_gazal_thirdblock_desc; ?></td>
                                <td><input type="text" name="gazal_thirdblock_desc" value="<?php echo $gazal_thirdblock_desc; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                    <!--///////////////////////////////////////////////////////////////////////////////// -->
                    <div id="fourthblock" class="tab_content">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="gazal_fourthblock_title" value="<?php echo $gazal_fourthblock_title; ?>" /></td>
                            </tr>
                            
                            <tr>
                                <td><?php echo $entry_gazal_fourthblock_desc; ?></td>
                                <td><input type="text" name="gazal_fourthblock_desc" value="<?php echo $gazal_fourthblock_desc; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                    <!--///////////////////////////////////////////////////////////////////////////////// -->
                    <div id="contactWidget" class="tab_content">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="gazal_address" value="<?php echo $gazal_address; ?>" /></td>
                            </tr>
                    ...
                    <div id="customWidget" class="tab_content">
                        <table class="form">
                        	<tr>   
                                ...
                                <td><input type="text" name="gazal_custom_widget_title" value="<?php echo $gazal_custom_widget_title; ?>" /></td>
                            </tr>
                            <tr>   
                                <td><?php echo $entry_gazal_footer_info_text; ?></td>
                                <td><textarea cols="50" rows="5" name="gazal_footer_info_text"><?php echo $gazal_footer_info_text; ?></textarea></td>
                            </tr>
                            <tr>   
                                <td>
                                    <?php echo $entry_custom_image; ?><br>
                            ...
                            <tr>   
                                ...
                                <td><input type="text" name="gazal_shipping_text" value="<?php echo $gazal_shipping_text; ?>" /></td>
                            </tr>
                            
                            <tr>   
                                <td><?php echo $entry_gazal_shipping_last_text; ?></td>
                                <td><input type="text" name="gazal_shipping_last_text" value="<?php echo $gazal_shipping_last_text; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                    <!--///////////////////////////////////////////////////////////////////////////////// -->
